...
-- Thời gian đã tạo: Th6 16, 2022 lúc 07:40 AM
...
(21, 0, 'sadas', 'dasdas', 'ádsa', 'qwqwqw@xn--das-dla', 0),
(22, 0, 'Tronggaga', 'Gc', '2121', 'qwqwqw@xn--dasds-wqa', 0),
(23, 0, 'Trongfgdfg', 'Gc', '10931290', 'qwqwqw@xn--das-dla', 0),
(24, 0, 'trr', 'dff', '1321', 'dffd@sds', 0);
...
(16, 21, '2022-06-06 10:23:24', 10000.00, 'ádas', 1, 0),
(17, 23, '2022-06-06 11:04:37', 3499.00, 'f', 1, 0),
(18, 24, '2022-06-14 07:43:26', 4000.00, 'sds', 1, 0);
...
(9, '4 lý do bạn nên sở hữu ngay một chú chó Rottweiler!', '1. Chó Rottweiler và những thông tin cơ bản – ngoại hình, tính cách cùng những phẩm chất tuyệt vời!\r\nTổng quan về những người bạn Rottweiler\r\n\r\nGiống như anh hùng Hy Lạp Hercules trong thần thoại, Rottweiler mạnh mẽ và chân thật với một trái tim nhân ái. Thường được gọi một cách trìu mến là Roti hoặc Rốt, giống chó này có nguồn gốc từ Đức, nơi nó được sử dụng để lùa gia súc và kéo xe cho nông dân và người bán thịt. Lịch sử đó được phản ánh qua khuôn ngực rộng và cơ thể rắn chắn của Rottweiler. Khi di chuyển, Rottweiler thể hiện sức mạnh và khả năng chịu đựng phi thường, nhưng khi bạn nhìn vào mắt những chú chó Rottweiler, bạn sẽ thấy những hồ nước ấm, màu nâu sẫm đem lại một cảm giác êm dịu, thông minh, lanh lợi và không sợ hãi.\r\nNgoại hình cứng cáp, mạnh mẽ khi trưởng thành của những chú chó Rottweiler\r\n\r\nRottweiler là một giống chó cỡ lớn có cơ thể khá cân đối, không quá nặng và cơ bắp nhưng cũng không quá nhẹ hay gầy yếu. \r\n\r\nChó Rottweiler đực trưởng thành có chiều cao trung bình từ 24 – 27 inch (60 – 68cm), cân nặng dao động từ 95 – 135 pound (41 – 61kg). Chó Rottweiler cái thì nhỏ hơn một chút với chiều cao trung bình từ 22 – 25 inch (56 – 64cm), cân nặng dao động từ 80 – 100 pound (36 – 45kg). Tỉ lệ hài hòa giữa cân nặng và chiều cao cho thấy giống chó Rottweiler có cơ thể tương đối cứng cáp, chắc chắn.\r\n\r\nĐầu của chó Rottweiler có dạng hình cầu, khoảng cách giữa hai tai lớn với chiếc mõm to bè trông khá hài hước, đáng yêu khi cười nhưng cũng hơi đáng sợ khi chúng “bật mode” nghiêm túc và cảnh giác với người lạ hoặc khi chúng chiến đấu. Mắt của chó Rottweiler có màu nâu đen rất linh hoạt, có đốm vàng ở gò má trên mắt, mõm và bốn chân. Trán tròn và cổ có chiều dài trung bình, không có phần da bùng nhùng dưới cổ, thịt chắc. \r\n\r\nHàm của chó Rottweiler rất phát triển và khỏe mạnh, cộng với hàm răng chắc và sắc bén giúp chúng làm tốt vai trò của chó nghiệp vụ, chăn nuôi gia súc trong chiến tranh và là “người gác cổng” uy nghiêm trong gia đình.\r\nLông của Rottweiler khá đẹp, ngắn và cứng, dày. Bộ lông của chúng mượt và ngắn nên rất dễ chăm sóc, chỉ phải tắm cho chúng khi cần thiết chứ không cân tắm quá thường xuyên.\r\n ', 1, '2022-06-12 07:58:06', '2022-06-12 07:58:06', 1, 2),
(8, 'Chó Alaskan Malamute có thật sự đáng', 'Giống chó Alaskan Malamute hay chó Alaska, là một trong những giống chó kéo xe cổ xưa nhất trên thế giới. Tên của giống chó này được đặt theo tên Mahlemut, một bộ tộc Eskimo sống du mục ở phía tây Alaska. Giống chó này được sử dụng làm chó kéo xe nhờ sức chịu đựng phi thường của chúng....', 1, '2022-06-08 02:40:00', '2022-06-08 02:40:00', 1, 2),
(10, 'Top 8 cửa hàng bán chó cảnh uy tín nhất tại Hà Nội', 'Tùng Lộc Pet – Cửa hàng bán chó cảnh uy tín tại Hà Nội\r\nCửa hàng bán chó cảnh uy tín Tùng Lộc Pet ra đời với mục tiêu mang đến những chú cún thuần chủng, khỏe mạnh cho các bạn yêu thú cưng tại Hà Nội. Để trở thành con giống ở đây, đàn chó bố, chó mẹ phải vượt qua quá trình chọn lựa nghiêm ngặt về nguồn gốc, độ thuần chủng. Và sau đó là quá trình nhân giống theo quy trình đạt chuẩn quốc tế.\r\nAZPET Shop – Cửa hàng bán chó cảnh uy tín tại Hà Nội\r\nRa đời từ 2009, AZPET Shop đã có hơn 10 năm kinh nghiệm hoạt động trong lĩnh vực mua bán, nhân giống, huấn luyện thú cưng. Thương hiệu này sở hữu trang trại chó và đã lai tạo thành công nhiều giống chó cảnh được ưa chuộng nhất tại nước ta hiện nay, ví dụ như Poodle, Alaska, Bull Pháp, Phốc Sóc, Corgi, Husky, Pug, Malinois, Lạp xưởng, Golden Retriever, Labrador, Samoyed v.v…\r\nVoodlehouse shop – Cửa hàng bán chó cảnh uy tín tại Hà Nội\r\nĐây là cửa hàng bán chó cảnh uy tín hàng đầu Hà Nội về giống Poodle. Voodlehouse Shop sở hữu trang trại nhân giống, đảm bảo nguồn gen thuần chủng, cung cấp đủ các loại Poodle từ Standard, Miniature, cho đến những dòng hiếm hơn như Tiny, Teacup, với nhiều màu sắc khác nhau để khách hàng thoải mái lựa chọn: nâu, đen, xám, chocolate, bò sữa, đỏ v.v…\r\n\r\n', 1, '2022-06-12 08:03:03', '2022-06-12 08:03:03', 1, 21),
(12, 'Mèo Anh lông ngắn Aln – Thông tin, đặc điểm', 'Mèo Anh lông ngắn hiện đang là giống mèo được ưa chuộng và nuôi phổ biến nhất tại Việt Nam và thế giới. Bạn thường nghĩ đến một chú mèo xám xanh với đôi mắt màu hổ phách khi nhắc đến giống mèo này. Nhưng thực ra mèo Anh lông ngắn có đến hơn 100 kiểu kết hợp màu và họa tiết. Hãy cùng trại mèo Dogily Cattery tìm hiểu những thông tin thú vị về đặc điểm, tính cách & nguồn gốc giống mèo Anh lông ngắn. Làm sao để chăm sóc mèo khỏe đẹp từ nhỏ đến trưởng thành? Mua mèo con ở đâu, giá bao nhiêu tiền. Tất cả đều được chúng tôi đề cập đến trong bài viết này.\r\nMèo Anh lông ngắn được biết phổ biến nhất với màu xám xanh, mắt vàng đồng. Chú mèo “Chanh” đực giống nhập Nga của Trại mèo Dogily Cattery.\r\n\r\nMèo Anh lông ngắn là một giống mèo có vẻ ngoài tương đối tròn trịa. Chúng có một cái đầu to tròn, đôi mắt và bàn chân tròn. Ngay cả chóp đuôi cũng tròn nốt. Từng được biết đến với cái tên British Blue do màu xám xanh quá phổ biến. Nhưng ngày ngay, bộ lông ngắn, thanh lịch của giống mèo này đã có hơn 100 màu sắc và hoa văn khác nhau. Lông của chúng lúc nào cũng bóng bẩy, mượt mà. Cảm giác mỗi lần chạm hay vuốt ve mèo cưng như đặt tay lên một tấm tảm nhung vậy. Nếu ở trong điều kiện khí hậu lanh, hay vào mùa đông, bộ lông mèo sẽ trở nên dày hơn.\r\n\r\nKhung xương lớn cùng với bộ ngực vạm vỡ khiến ngoại hình của mèo Anh lông ngắn trông rất săn chắc, khỏe mạnh. Bốn chân tương đối ngắn, với phần đệm thịt ở bàn chân dày, mềm giúp cho việc di chuyển của mèo luôn nhẹ nhàng, uyển chuyển. Phần da ở mũi và đệm bàn chân luôn phải phù hơp với màu sắc của bộ lông. Gương mặt to, tròn, má phúng phính như “bánh bao”. Tai nhỏ, hình tam giác thuôn nhọn trên đỉnh đầu.\r\n\r\nMàu mắt phổ biến nhất là màu vàng đồng (hay hổ phách, vàng cam) ở hầu hết các màu lông. Riêng một số màu như trắng, golden, silver… có thể chấp nhận mắt màu xanh. Hoặc hiếm, đẹp và lạ hơn là mắt 2 màu (một vàng, một xanh).', 1, '2022-06-12 09:15:52', '2022-06-12 09:15:52', 1, 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `nguyenvanminhtrong_posts`
--

DROP TABLE IF EXISTS `nguyenvanminhtrong_posts`;
CREATE TABLE IF NOT EXISTS `nguyenvanminhtrong_posts` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `nguyenvanminhtrong_posts`
--

INSERT INTO `nguyenvanminhtrong_posts` (`id`, `title`, `url`, `content`, `image`) VALUES
(1, 'ads', 'sa', 'ádasda', '2.jpg');
...
(1, 'Chó Corrgi', 'cho-corghi', 1, 1, 'orgi có thân hình rất đáng yêu, mình dài, chân ngắn và quả mông trái tim siêu bự. Bản tính của Corgi rất năng động, thông minh và hết sức trung thành có thể sẵn sàng hi sinh để bảo vệ chủ của mình. Chú chó chân ngắn mông to này gồm 2 dòng chó cơ bản là Pembroke Welsh Corgi và Cardigan Corgi. Sự khác nhau giữa 2 dòng chó này là Cardigan có đuôi còn Pembroke thì cụt đuôi.. Cân nặng và chiều cao cũng có sự khác nhau đáng kể, Cadigan cao khoảng 25-33 cm và nặng 11-14 kg; Pembroke cao 25-30 cm và nặng 11-13kg. Tuổi thọ 12-15 năm.', 3499.000, 2995.000, 'cho-corgi-5-1-1024x576 (1).jpg', 0, 1),
...
--
-- Cấu trúc đóng vai cho view `thông tin`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `thông tin`;
CREATE TABLE IF NOT EXISTS `thông tin` (
`contactId` int(11)
,`email` varchar(100)
,`title` varchar(100)
,`content` text
...
--
-- Cấu trúc cho view `thông tin`
--
DROP TABLE IF EXISTS `thông tin`;

DROP VIEW IF EXISTS `thông tin`;
CREATE ALGORITHM=UNDEFINED DEFINER=`Tin tức`@`%` SQL SECURITY DEFINER VIEW `thông tin`  AS SELECT `nguyenvanminhtrong_contact`.`contactId` AS `contactId`, `nguyenvanminhtrong_contact`.`email` AS `email`, `nguyenvanminhtrong_contact`.`title` AS `title`, `nguyenvanminhtrong_contact`.`content` AS `content`, `nguyenvanminhtrong_contact`.`trash` AS `trash`, `nguyenvanminhtrong_contact`.`status` AS `status` FROM `nguyenvanminhtrong_contact` ;
COMMIT;
